...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('human_resources', '0024_alter_dettaglioregistroformazione_certificato_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='entry_month',
            field=models.IntegerField(choices=[(1, 'Gennaio'), (2, 'Febbraio'), (3, 'Marzo'), (4, 'Aprile'), (5, 'Maggio'), (6, 'Giugno'), (7, 'Luglio'), (8, 'Agosto'), (9, 'Settembre'), (10, 'Ottobre'), (11, 'Novembre'), (12, 'Dicembre')], default=1),
        ),
        migrations.AlterField(
            model_name='registroorelavoro',
            name='entry_year',
