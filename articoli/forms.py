    ...
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci Nome Articolo"}
            ),
...
class ColoreModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci Nome colore"}
            ),
            "created_by": forms.HiddenInput(),
            "created_at": forms.HiddenInput(),
        }
...
class LavorazioneEsternaModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci Nome Lavorazione"}
            ),
            "codice": forms.TextInput(
                attrs={"placeholder": "Inserisci Codice Lavorazione"}
            ),
            "created_by": forms.HiddenInput(),
            "created_at": forms.HiddenInput(),
        }
...
class FaseLavoroModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci Nome Fase"}
            ),
            "created_by": forms.HiddenInput(),
            "created_at": forms.HiddenInput(),
        }
        labels = {"descrizione": "Fase di Lavoro", "interno_esterno": "Interno/Esterno"}
...
class DettaglioFaseLavoroModelForm(forms.ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "attributo": forms.TextInput(
                attrs={
                    "placeholder": "Inserisci attributo fase (Temperatura, Codice,...)"
                }
            ),
        ...
        labels = {"attributo": "Attributo", "note": "Note"}
...
class ElencoTestModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci Nome Test"}
            ),
            "norma_riferimento": forms.TextInput(
                attrs={"placeholder": "Inserisci norma di riferimento"}
            ),
            "created_by": forms.HiddenInput(),
            "created_at": forms.HiddenInput(),
        }
...
class ProceduraModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nr_procedura": forms.NumberInput(
                attrs={"class": "form-control text-end", "readonly": "True"}
            ),
            "data_procedura": forms.DateInput(
                format=("%Y-%m-%d"),
                attrs={"class": "form-control text-end", "type": "date"},
            ),
            "nr_revisione": forms.NumberInput(
                attrs={"class": "form-control text-end", "readonly": "True"}
            ),
            "data_revisione": forms.DateInput(
                format=("%Y-%m-%d"),
                attrs={"class": "form-control text-end", "type": "date"},
            ),
            "note": forms.Textarea(
...
class DettaglioProceduraModelForm(forms.ModelForm):
    class Meta:
        ...
        fk_faselavoro = forms.ModelChoiceField(
            queryset=FaseLavoro.objects.all(), widget=forms.Select
        )
...
class CaratteristicaProceduraModelForm(forms.ModelForm):
    class Meta:
        ...
        fk_fornitore = forms.ModelChoiceField(
            queryset=Fornitore.objects.all(), widget=forms.Select
        )
        fk_dettaglio_fase_lavoro = forms.ModelChoiceField(
            queryset=DettaglioFaseLavoro.objects.all(), widget=forms.Select
        )
        fk_lavorazione_esterna = forms.ModelChoiceField(
            queryset=LavorazioneEsterna.objects.all(), widget=forms.Select
        )
