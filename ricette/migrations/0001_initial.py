# Generated by Django 4.2.1 on 2024-03-20 19:20
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        limit_choices_to=ricette.models.DettaglioRicettaRifinizione.get_choices_operations,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_ricette_rifinizione",
                ...
                (
                    "fk_prodotto_chimico",
                    models.ForeignKey(
                        limit_choices_to=ricette.models.DettaglioRicettaRifinizione.get_choices_chemical,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_ricette_rifinizione",
                ...
                (
                    "fk_ricetta_rifinizione",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_ricette_rifinizione",
                        to="ricette.ricettarifinizione",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fk_operazione_ricette",
                    models.ForeignKey(
                        limit_choices_to=ricette.models.DettaglioRicettaColoreRifinizione.get_choices_operations,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_colore_rifinizione",
                        to="ricette.operazionericette",
                    ),
                ...
                (
                    "fk_prodotto_chimico",
                    models.ForeignKey(
                        limit_choices_to=ricette.models.DettaglioRicettaColoreRifinizione.get_choices_chemical,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_colore_rifinizione",
                        to="chem_man.prodottochimico",
                    ),
                ...
                (
                    "fk_ricetta_colore_rifinizione",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_colore_rifinizione",
                        to="ricette.ricettacolorerifinizione",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fk_operazione_ricette",
                    models.ForeignKey(
                        limit_choices_to=ricette.models.DettaglioRicettaBagnato.get_choices_operations,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="dettaglio_ricette_bagnato",
                        to="ricette.operazionericette",
                    ),
