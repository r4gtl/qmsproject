...
class PuntoEmissioneModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
                ...
                'portata': forms.NumberInput(attrs={'class': 'form-control', 'style': 'text-align: right;'}),
                'parametri': forms.TextInput(attrs={'placeholder': 'Inserisci il parametro del punto di emissione'}),
                'limite_conc': forms.NumberInput(attrs={'class': 'form-control', 'style': 'text-align: right;'}),
                'limite_flusso': forms.NumberInput(attrs={'class': 'form-control', 'style': 'text-align: right;'}),       
