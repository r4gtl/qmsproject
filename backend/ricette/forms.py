    ...
    class Meta:
        ...
        widgets = {
            "descrizione": forms.TextInput(
                attrs={"placeholder": "Inserisci descrizione operazione"}
            ),
        ...
        labels = {"descrizione": "Descrizione", "ward_ref": "Reparto", "note": "Note"}
...
class RicettaRifinizioneModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fk_articolo = forms.ModelChoiceField(
            queryset=Articolo.objects.all(), widget=forms.Select
        )

        widgets = {
            "numero_ricetta": forms.NumberInput(
                attrs={"class": "form-control text-end", "readonly": "True"}
            ),
            "data_ricetta": forms.DateInput(
                format=("%Y-%m-%d"),
                attrs={"class": "form-control text-end", "type": "date"},
            ),
            "numero_revisione": forms.NumberInput(
                attrs={"class": "form-control text-end", "readonly": "True"}
            ),
            ...
            "ricetta_per_pelli": forms.NumberInput(
                attrs={"class": "form-control text-end"}
            ),
            "note": forms.Textarea(
                attrs={"placeholder": "Inserisci Annotazioni", "rows": "3"}
            ),
...
class RicettaColoreRifinizioneModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fk_colore = forms.ModelChoiceField(
            queryset=Colore.objects.all(), widget=forms.Select
        )
...
class RicettaBagnatoModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fk_tipogrezzo = forms.ModelChoiceField(
            queryset=TipoGrezzo.objects.all(), widget=forms.Select
        )
        fk_tipoanimale = forms.ModelChoiceField(
            queryset=TipoAnimale.objects.all(), widget=forms.Select
        )
...
class RicettaColoreBagnatoModelForm(forms.ModelForm):
...
class DettaglioRicettaColoreBagnatoModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "created_by": forms.HiddenInput(),
            "fk_ricetta_colore_bagnato": forms.HiddenInput(),
        }
        labels = {
            "numero_riga": "Ordinale",
            "fk_operazione_ricette": "Operazione",
...
class XRFondoColoreModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {"fk_colore": "Colore", "note": "Note"}
