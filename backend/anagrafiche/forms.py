    ...
    class Meta:
        ...
        widgets = {
            "numero": forms.TextInput(
                attrs={"placeholder": "Inserisci il numero dell'autorizzazione..."}
            ),
...
class ListinoTerzistaModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {"note": "Note", "fk_lavorazione_esterna": "Codice Lavorazione"}
...
class PrezzoListinoModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "data_inserimento": forms.DateInput(
                format=("%Y-%m-%d"), attrs={"class": "form-control", "type": "date"}
            ),
...
class ListinoClienteModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fk_articolo = forms.ModelChoiceField(
            queryset=Articolo.objects.all(), label="Articolo"
        )
        widgets = {
            "prezzo": forms.NumberInput(attrs={"class": "form-control"}),
            "note": forms.Textarea(
        ...
        labels = {"fk_articolo": "Articolo", "prezzo": "Prezzo", "note": "Note"}
