...
urlpatterns = [
    ...
    path(
        "aggiungi_fornitore_with_category/<str:category>/",
        aggiungi_fornitore_with_category,
        name="aggiungi_fornitore_with_category",
    ),
    ...
    # Listino terzisti
    path(
        "fornitore/<int:fk_fornitore>/aggiungi_voce_listino/",
        ListinoTerzistaCreateView.as_view(),
        name="aggiungi_voce_listino",
    ),
    path(
        "modifica_voce_listino/<int:pk>",
        ListinoTerzistaUpdateView.as_view(),
        name="modifica_voce_listino",
    ),
    path(
        "delete_voce_listino/<int:pk>", delete_voce_listino, name="delete_voce_listino"
    ),
    path(
        "<int:fk_listino_terzista>/aggiungi_prezzo_listino/",
        PrezzoListinoCreateView.as_view(),
        name="aggiungi_prezzo_listino",
    ),
    path(
        "modifica_prezzo_listino/<int:pk>",
        PrezzoListinoUpdateView.as_view(),
        name="modifica_prezzo_listino",
    ),
    path(
        "delete_prezzo_listino/<int:pk>",
        delete_prezzo_listino,
        name="delete_prezzo_listino",
    ),
    # Gestori Rifiuti
    path(
        "fornitore/<int:fk_fornitore>/aggiungi_gestore_rifiuti/",
        XrDocumentiGestoreCreateView.as_view(),
        name="aggiungi_gestore_rifiuti",
    ),
    path(
        "modifica_gestore_rifiuti/<int:pk>",
        XrDocumentiGestoreUpdateView.as_view(),
        name="modifica_gestore_rifiuti",
    ),
    path(
        "delete_gestore_rifiuti/<int:pk>",
        delete_gestore_rifiuti,
        name="delete_gestore_rifiuti",
    ),
    # Listino Clienti
    path(
        "cliente/<int:fk_cliente>/aggiungi_voce_listino_cliente/",
        ListinoClienteCreateView.as_view(),
        name="aggiungi_voce_listino_cliente",
    ),
    path(
        "modifica_voce_listino_cliente/<int:pk>",
        ListinoClienteUpdateView.as_view(),
        name="modifica_voce_listino_cliente",
    ),
    path(
        "delete_voce_listino_cliente/<int:pk>",
        delete_voce_listino_cliente,
        name="delete_voce_listino_cliente",
    ),
    # Tabelle Generiche
